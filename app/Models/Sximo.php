...
class Sximo extends Model {
	...
	public static function querySelectCount($table){
	...
	public static function getRows( $args )
	{
	   ...
	   $key = with(new static)->primaryKey;
		...
		$totalItems = 0;
		$total = \DB::select( self::querySelectCount($table) . self::queryWhere(). "
...
//		$total = $res[0]->total;
		...
		return $results = array('rows'=> $result , 'total' => $totalItems);
