...
<link rel="shortcut icon" href="{{ asset('favicon.ico')}}" type="image/x-icon">	
		...
		<link href="{{ asset('sximo/js/plugins/datatable/css/jquery.dataTables.min.css') }}" rel="stylesheet">
		...
		@endif
		<link href="{{ asset('sximo/css/custom.css')}}" rel="stylesheet">
	...
	<script type="text/javascript" src="{{ asset('sximo/js/plugins/jquery.min.js') }}"></script>
		...
		<script type="text/javascript" src="{{ asset('sximo/js/plugins/datatable/js/jquery.dataTables.min.js') }}"></script>
	...
	<!--[if lt IE 9]>
  	...
  	<body class="sxim-init page-{{$controller}}-{{$action}}">
	<div id="wrapper">
